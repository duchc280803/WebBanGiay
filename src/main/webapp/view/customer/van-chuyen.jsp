        ...
        <div class="col-9">
            <div class="container mt-4">
                ...
                <ul class="nav nav-pills">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" href="/customer/van-chuyen">Vận chuyển</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="/customer/dang-giao">Đang giao</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="/customer/hoan-thanh">Hoàn thành</a>
                    </li>
                    <li class="nav-item">
                ...
                <c:forEach var="list" items="${donHangDTOList}" varStatus="index">
                    <div class="card mt-4">
                        ...
                        <div class="card-body">
                            ...
                            <p class="card-text">${list.status == 2 ? 'Vận Chuyển' : ''}</p>
                        </div>
                    </div>
                </c:forEach>
            </div>
